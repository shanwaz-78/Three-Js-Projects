...
// // Endpoint for get the current number of likes
// app.get("/likes", (req, res) => {
//   res.json({ likes: videoLikes });
// });

// // Endpoint for incrementing the likes
// app.post("/like", (req, res) => {
//   videoLikes++;
//   res.json({ like: videoLikes });
// });

// // Endpoint for decrement the likes
// app.post("/unlike", (req, res) => {
//   if (videoLikes > 0) {
//     videoLikes--;
//   }
//   res.json({ unlike: videoLikes });
// });
